...
class CentralIndex:
	...
	@return - the data from the api
	'''
	def putBusinessJson(self,json='',country='',timezone=''):
		params = {}
		if(json != ''): 
			params['json'] = json
		if(country != ''): 
	...
	@return - the data from the api
	'''
	def postBusinessJsonProcess(self,queue_id=''):
		params = {}
		if(queue_id != ''): 
	...
	@return - the data from the api
	'''
	def getEntitySearchGroupBynearest(self,group_id='',country='',per_page='',page='',language='',latitude='',longitude='',domain='',path='',unitOfDistance=''):
		params = {}
		if(group_id != ''): 
			params['group_id'] = group_id
		if(country != ''): 
