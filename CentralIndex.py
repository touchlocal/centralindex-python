...
class CentralIndex:
	...
	@return - the data from the api
	'''
	def postAgency(self,agency_id='',country='',name='',description='',active=''):
		params = {}
		if(agency_id != ''): 
		...
		return self.doCurl("POST","/agency",params)
	...
	def getAgency(self,agency_id=''):
		...
		if(agency_id != ''): 
			params['agency_id'] = agency_id
		return self.doCurl("GET","/agency",params)
	...
	@return - the data from the api
	'''
	def deleteAgency(self,agency_id=''):
		params = {}
		if(agency_id != ''): 
			params['agency_id'] = agency_id
		return self.doCurl("DELETE","/agency",params)
	...
	@return - the data from the api
	'''
	def putBusiness(self,name='',building_number='',branch_name='',address1='',address2='',address3='',district='',town='',county='',province='',postcode='',country='',latitude='',longitude='',timezone='',telephone_number='',additional_telephone_number='',email='',website='',category_id='',category_type='',do_not_display='',referrer_url='',referrer_name=''):
		params = {}
		if(name != ''): 
			params['name'] = name
		if(building_number != ''): 
	...
	@return - the data from the api
	'''
	def getContract_logSuccess_by_date(self,date='',success=''):
		params = {}
		if(date != ''): 
			params['date'] = date
		if(success != ''): 
			params['success'] = success
		return self.doCurl("GET","/contract_log/success_by_date",params)
	...
	@return - the data from the api
	'''
	def postEntityAgency(self,entity_id='',agency_id=''):
		params = {}
		if(entity_id != ''): 
			params['entity_id'] = entity_id
		if(agency_id != ''): 
			params['agency_id'] = agency_id
		return self.doCurl("POST","/entity/agency",params)
	...
	@return - the data from the api
	'''
	def deleteEntityAgency(self,entity_id='',gen_id=''):
		params = {}
		if(entity_id != ''): 
			params['entity_id'] = entity_id
		if(gen_id != ''): 
			params['gen_id'] = gen_id
		return self.doCurl("DELETE","/entity/agency",params)
	...
	@return - the data from the api
	'''
	def getEntityBy_agencyid(self,agency_id=''):
		params = {}
		if(agency_id != ''): 
			params['agency_id'] = agency_id
		return self.doCurl("GET","/entity/by_agencyid",params)
	...
	@return - the data from the api
	'''
	def postProduct(self,product_id='',name='',strapline='',price='',currency='',active='',billing_period=''):
		params = {}
		if(product_id != ''): 
			params['product_id'] = product_id
		if(name != ''): 
	...
	@return - the data from the api
	'''
	def postSyndicationRenew(self,syndication_type='',publisher_id='',entity_id='',group_id='',seed_masheryid='',supplier_masheryid='',country='',reseller_masheryid='',expiry_date=''):
		params = {}
		if(syndication_type != ''): 
			params['syndication_type'] = syndication_type
		if(publisher_id != ''): 
	...
	@return - the data from the api
	'''
	def getToolsSyndicateEnablemedia(self,entity_id='',reseller_masheryid='',destructive=''):
		params = {}
		if(entity_id != ''): 
			params['entity_id'] = entity_id
		if(reseller_masheryid != ''): 
	...
	@return - the data from the api
	'''
	def postUser(self,email='',user_id='',first_name='',last_name='',active='',trust='',creation_date='',user_type='',social_network='',social_network_id='',reseller_admin_masheryid='',group_id='',admin_upgrader='',agency_id=''):
		params = {}
		if(email != ''): 
			params['email'] = email
		if(user_id != ''): 
