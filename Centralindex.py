...
class CentralIndex:
	...
	@return - the data from the api
	'''
	def postEntityAnnouncement(self,entity_id='',headline='',body='',link_label='',link='',terms_link='',expiry_date='',media_type='',youtube_embed_code='',image_url='',filedata=''):
		params = {}
		if(entity_id != ''): 
			params['entity_id'] = entity_id
		if(headline != ''): 
	...
	@return - the data from the api
	'''
	def postVendastaListing(self,entity_id=''):
		params = {}
		if(entity_id != ''): 
			params['entity_id'] = entity_id
		return self.doCurl("POST","/vendasta/listing",params)
	...
	@return - the data from the api
	'''
	def postVendastaReview(self,listing_id='',review_id='',title='',content='',star_rating='',reviewer_name='',reviewer_email='',published_date='',url=''):
		params = {}
		if(listing_id != ''): 
		...
		if(url != ''): 
			params['url'] = url
		return self.doCurl("POST","/vendasta/review",params)
