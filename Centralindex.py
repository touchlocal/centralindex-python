...
class CentralIndex:
	...
	@return - the data from the api
	'''
	def getAutocompleteCategoryId(self,str='',language=''):
		params = {}
		if(str != ''): 
			params['str'] = str
		if(language != ''): 
	...
	@return - the data from the api
	'''
	def getEntityAdvertisers(self,tag='',where='',is_national='',limit='',country='',language='',benchmark=''):
		params = {}
		if(tag != ''): 
			params['tag'] = tag
		if(where != ''): 
	...
	@return - the data from the api
	'''
	def postEntityAnnouncement(self,entity_id='',headline='',body='',link_label='',link='',terms_link='',expiry_date='',media_type='',youtube_embed_code='',image_url='',filedata='',type=''):
		params = {}
		if(entity_id != ''): 
			params['entity_id'] = entity_id
		if(headline != ''): 
	...
	@return - the data from the api
	'''
	def postEntityClaimReseller(self,entity_id=''):
		params = {}
		if(entity_id != ''): 
			params['entity_id'] = entity_id
	...
	@return - the data from the api
	'''
	def postEntityReview(self,entity_id='',reviewer_user_id='',review_id='',title='',content='',star_rating='',domain=''):
		params = {}
		if(entity_id != ''): 
			params['entity_id'] = entity_id
		if(reviewer_user_id != ''): 
	...
	@return - the data from the api
	'''
	def getEntityReviewList(self,entity_id='',per_page='',cursor=''):
		params = {}
		if(entity_id != ''): 
			params['entity_id'] = entity_id
		if(per_page != ''): 
	...
	@return - the data from the api
	'''
	def getEntitySearchBylocation(self,where='',per_page='',page='',country='',language='',latitude='',longitude='',domain='',path='',restrict_category_ids='',benchmark=''):
		params = {}
		if(where != ''): 
			params['where'] = where
		if(per_page != ''): 
	...
	@return - the data from the api
	'''
	def getEntitySearchKeywordBynearest(self,keyword='',country='',per_page='',page='',language='',latitude='',longitude='',domain='',path='',restrict_category_ids='',include_ads=''):
		params = {}
		if(keyword != ''): 
	...
	@return - the data from the api
	'''
	def getEntitySearchWhat(self,what='',per_page='',page='',country='',language='',domain='',path='',restrict_category_ids='',benchmark=''):
		params = {}
		if(what != ''): 
			params['what'] = what
		if(per_page != ''): 
	...
	@return - the data from the api
	'''
	def getEntitySearchWhatBylocation(self,what='',where='',per_page='',page='',country='',language='',latitude='',longitude='',domain='',path='',restrict_category_ids='',benchmark=''):
		params = {}
		if(what != ''): 
			params['what'] = what
		if(where != ''): 
	...
	@return - the data from the api
	'''
	def getEntitySearchWho(self,who='',per_page='',page='',country='',language='',domain='',path='',restrict_category_ids='',benchmark=''):
		params = {}
		if(who != ''): 
			params['who'] = who
		if(per_page != ''): 
	...
	@return - the data from the api
	'''
	def getEntitySearchWhoBylocation(self,who='',where='',per_page='',page='',country='',latitude='',longitude='',language='',domain='',path='',restrict_category_ids='',benchmark=''):
		params = {}
		if(who != ''): 
			params['who'] = who
		if(where != ''): 
	...
	@return - the data from the api
	'''
	def getLeadsAdded(self,country_id='',from_date='',to_date='',limit='',offset=''):
		params = {}
		if(country_id != ''): 
			params['country_id'] = country_id
		if(from_date != ''): 
	...
	@return - the data from the api
	'''
	def getLeadsAdvertisers(self,country_id='',from_date='',to_date='',limit='',offset=''):
		params = {}
		if(country_id != ''): 
			params['country_id'] = country_id
		if(from_date != ''): 
	...
	@return - the data from the api
	'''
	def getLeadsClaimed(self,country_id='',from_date='',to_date='',limit='',offset=''):
		params = {}
		if(country_id != ''): 
			params['country_id'] = country_id
		if(from_date != ''): 
	...
	@return - the data from the api
	'''
	def postPlugin(self,id='',slug='',owner='',scope='',status=''):
		params = {}
		if(id != ''): 
			params['id'] = id
		if(slug != ''): 
	...
	@return - the data from the api
	'''
	def postPluginActivate(self,entity_id='',plugin='',expiry_date=''):
		params = {}
		if(entity_id != ''): 
			params['entity_id'] = entity_id
		if(plugin != ''): 
	...
	@return - the data from the api
	'''
	def postProduct(self,product_id='',name='',strapline='',paygateid='',price='',tax_rate='',currency='',active='',billing_period='',title='',intro_paragraph='',bullets='',outro_paragraph='',thanks_paragraph=''):
		params = {}
		if(product_id != ''): 
	...
	@return - the data from the api
	'''
	def postScoot_priority(self,entity_id='',reseller=''):
		params = {}
		if(entity_id != ''): 
			params['entity_id'] = entity_id
		if(reseller != ''): 
	...
	@return - the data from the api
	'''
	def getTokenClaim(self,entity_id='',language='',portal_name='',flatpack_id='',admin_host=''):
		params = {}
		if(entity_id != ''): 
			params['entity_id'] = entity_id
		if(language != ''): 
	...
	@return - the data from the api
	'''
	def getTokenLoginSet_password(self,email='',flatpack_id='',entity_id='',action=''):
		params = {}
		if(email != ''): 
			params['email'] = email
		if(flatpack_id != ''): 
